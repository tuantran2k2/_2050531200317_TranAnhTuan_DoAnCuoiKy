...
cookie = {
    'name': 'li_at',
    'value': 'AQEDAVCQlYkB_tt4AAABkvybvKEAAAGTIKhAoU4AZinDuLIhnYCd2umZS3B-7HQyNQvoDPgYW4LQWJJlB14is0_IsNqN9hA0-sCeYnTlwUXbzpuKNNDHVNzZZmtFoadj_3OpWhvUSX4sic0p7jegRlhB',  # Thay bằng giá trị cookie thực tế của bạn
    'domain': '.linkedin.com',
    'path': '/',
    'secure': True,
    'httpOnly': True
