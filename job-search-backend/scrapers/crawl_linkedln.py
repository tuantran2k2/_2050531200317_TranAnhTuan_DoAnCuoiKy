...
with sync_playwright() as p:
    ...
    page.context.add_cookies([{
        'name': 'li_at',
        'value': 'AQEDAVCQlYkEQx_gAAABkgAErvsAAAGS92QEmVYAwJ1xtabXoyNOVXj4EWlbWaOANhdhdnre2dWSj-hECxyHCRZXXgk7BdiTuMwvfieD52WR7kMy-MFDZxmHlyrp-_R-6cadExMGua5-wHtIgEo1Xvjn',
        'domain': '.linkedin.com',
        'path': '/',
        'secure': True,
        'httpOnly': True
