...
cookie = {
    'name': 'li_at',
    'value': 'AQEDAVCQlYkCSEOWAAABkvx8dEwAAAGTIIj4TFYAI1hLvg-cC52nQ00e2NAnLUCx8j39EUDYau2_7kjCerdglEDoPyFRh0ku1EFqrw5fsXmHN9Bw8MngV89WaGcXphSfwiEQd4PpvO5rPFcZ9xVtmsqg',  # Thay bằng giá trị cookie thực tế của bạn
    'domain': '.linkedin.com',
    'path': '/',
    'secure': True,
    'httpOnly': True
