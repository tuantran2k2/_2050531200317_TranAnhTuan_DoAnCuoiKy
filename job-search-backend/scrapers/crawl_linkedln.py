...
cookie = {
    'name': 'li_at',
    'value': 'AQEDAVCQlYkFJtx0AAABkvy2j8UAAAGTIMMTxU4AuNUrMGLLJ8UXa_zz_nNqBaw4tj-kKlYkclYE5fRlfldrJaABM44-1h1vaj4ue_-Bp-b27-Uc1uBxwGRKPvmrQKFZqhHHfW3UAHZHOClc0rjwnkRM',  # Thay bằng giá trị cookie thực tế của bạn
    'domain': '.linkedin.com',
    'path': '/',
    'secure': True,
    'httpOnly': True
